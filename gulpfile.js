...
// Set NODE_ENV to 'production test'
gulp.task('env:prodTest', function () {
...
gulp.task('nodemon', function () {
  return plugins.nodemon({
    ...
    nodeArgs: ['--debug'],
    ext: 'js,html',
    watch: _.union(defaultAssets.server.views, defaultAssets.server.allJS, defaultAssets.server.config, '!uploads')
  });
});
...
// Run the project in production test mode
gulp.task('prodTest', function (done) {
  runSequence('templatecache', 'build', 'env:prodTest', 'lint', ['nodemon', 'watch'], done);
});

gulp.task('buildProd', function (done) {
  runSequence(['cssmin','uglify','templatecache'],done);
});
