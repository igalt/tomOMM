(function(){
  ...
  app.component('applicationsCreateComponent', {
    bindings: {
      application: '=',
      makeathon: '='
    },
    templateUrl: 'modules/applications/client/views/form-application.client.view.html',
    controller: applicationsCreateComponent,
    controllerAs: 'vm'
  });

  applicationsCreateComponent.$inject = ['$scope', '$state', 'Authentication', '$stateParams',
                                    '$http', 'SendMailService', 'CommonService'];
  function applicationsCreateComponent ($scope, $state, Authentication, $stateParams,
                                   $http, SendMailService, CommonService) {
    var vm = this;
    ...
    // New application
    applicationCreateInit();

    function applicationCreateInit(){
      getAllTags();
