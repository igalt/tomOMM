  ...
  describe('Challenges Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleChallengePostData = new ChallengesService({
          name: 'Challenge Name'
        });

        $scope.vm.challenge = sampleChallengePostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ChallengesService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('challenges.view', {
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        ...
        $scope.vm.challenge = mockChallenge;
      });

      it('should update a valid Challenge', inject(function (ChallengesService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (ChallengesService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Challenge and redirect to Challenges', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('challenges.list');
      });

      it('should should not delete the Challenge and not redirect', function () {
